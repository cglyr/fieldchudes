...
emp1 = ["Оферта", "Дорога", "Рабство", "Революция", "Уничтожение", "Улица", "Убийства", "Притеснение", "Африканец", "Афёра", "Поля", "Хлопок", "Лён", "Нитрат", "Нитрит", "Разгром", "Ассимиляция", "Монархия", "Штурм", "Преграда", "Дом", "Обвинение", "Автотроника"]
p1 = 10
a = choice(emp1).lower()
hf = a
hf = list(a.lower())
